...
public class UpdateVehicleModelsCommand : ICommand<bool>
{
...
public class UpdateVehicleModelsCommandHandler(
    IUnitOfWork unitOfWork,
    IPublishEndpoint publishEndpoint) : IRequestHandler<UpdateVehicleModelsCommand, bool>
{
    public async Task<bool> Handle(UpdateVehicleModelsCommand request, CancellationToken cancellationToken)
    {
        return await unitOfWork.ExecuteInTransactionAsync(async (ct) =>
        {
            ...
            vehicleModel.NumberPlate = request.NumberPlate;
            vehicleModel.Mileage = request.Mileage;
            vehicleModel.ConditionNotes = request.ConditionNotes;
            vehicleModel.LocationId = request.LocationId;
