...
public static class AuthMessage
{
    ...
    public static class ResetPassword
    {
        ...
        public const string InvalidToken = "Đường dẫn không hợp lệ";
        public const string ExpiredToken = "Đường dẫn đã hết hạn";
    }

    public static class LoginAfterResetPassword
    {
