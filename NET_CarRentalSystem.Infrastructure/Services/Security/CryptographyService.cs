...
namespace NET_CarRentalSystem.Infrastructure.Services.Security;

public class CryptographyService(IOptions<RsaSettings> rsaSettings, IOptions<AesSettings> aesSettings) : ICryptographyService
{
