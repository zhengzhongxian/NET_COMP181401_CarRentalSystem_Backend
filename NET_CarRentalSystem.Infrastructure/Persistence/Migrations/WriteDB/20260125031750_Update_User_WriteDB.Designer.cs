...
namespace NET_CarRentalSystem.Infrastructure.Persistence.Migrations.WriteDB
{
    ...
    [Migration("20260125031750_Update_User_WriteDB")]
    partial class Update_User_WriteDB
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NET_CarRentalSystem.Domain.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 25, 3, 17, 47, 393, DateTimeKind.Utc).AddTicks(8541),
                            ...
                            UpdatedAt = new DateTime(2026, 1, 25, 3, 17, 47, 393, DateTimeKind.Utc).AddTicks(8541),
            ...
            modelBuilder.Entity("NET_CarRentalSystem.Domain.Entities.Fuel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 25, 3, 17, 47, 394, DateTimeKind.Utc).AddTicks(6014),
                            Description = "Sử dụng xăng",
                            IsDeleted = false,
                            Name = "Gasoline",
                            RowVersion = new byte[0],
                            UpdatedAt = new DateTime(2026, 1, 25, 3, 17, 47, 394, DateTimeKind.Utc).AddTicks(6014)
                        },
                        new
                        {
            ...
            modelBuilder.Entity("NET_CarRentalSystem.Domain.Entities.InsurancePackage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 25, 3, 17, 47, 395, DateTimeKind.Utc).AddTicks(3899),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 25, 3, 17, 47, 395, DateTimeKind.Utc).AddTicks(3901),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 25, 3, 17, 47, 395, DateTimeKind.Utc).AddTicks(3904),
            ...
            modelBuilder.Entity("NET_CarRentalSystem.Domain.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Hồ Chí Minh",
                            CreatedAt = new DateTime(2026, 1, 25, 3, 17, 47, 396, DateTimeKind.Utc).AddTicks(776),
                            IsDeleted = false,
                            Latitude = 10.7758,
                            Longitude = 106.702,
                            ...
                            RowVersion = new byte[0],
                            UpdatedAt = new DateTime(2026, 1, 25, 3, 17, 47, 396, DateTimeKind.Utc).AddTicks(776)
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000002"),
            ...
            modelBuilder.Entity("NET_CarRentalSystem.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "8eab1fa8-bd01-4910-9188-20bc7e3151f2",
                            IsDeleted = false,
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "f8f731e9-2862-46a6-bccc-fd2e9e9e0ba4",
                            IsDeleted = false,
                            Name = "Manager",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "9a421649-f7c4-427d-b4a2-8cbbb3cbfa4b",
                            IsDeleted = false,
                            Name = "Staff",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "c9d06f26-7872-401f-80e5-9f8a0d3de446",
                            IsDeleted = false,
                            Name = "Customer",
            ...
            modelBuilder.Entity("NET_CarRentalSystem.Domain.Entities.RoleClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("147e3fa7-80a5-4850-9e85-3b9dfbf77d08"),
                        ...
                        new
                        {
                            Id = new Guid("5b976ebb-1e69-42e1-a541-ff503ed3136c"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("190c3afb-aa47-41e4-922f-742aadc1784f"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("512152b9-76c8-4277-bff7-f2423067b398"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("a5e5694a-0954-4aef-905d-82d06e3ce5d2"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("89bce11d-284a-48a6-98d6-dd0a2293ce19"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("ae90ab6e-2b08-4d69-a484-7bb9403d8786"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("241b8261-27cd-42b2-8624-6932566b9478"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("0451c8b6-f97f-4157-81fa-823e8e111aad"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("0e3a6c8a-d8fe-4037-aaeb-c2baeaa9ce99"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("cfda4e55-57c6-40ae-b398-69c3e13f7669"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("a6658f59-a7dd-415e-a428-0b4a037de8b2"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("c6bf9543-710b-47b3-bcf6-8869dd36f683"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("3b2032b1-cacf-4ada-bf9e-4006412a2bf8"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("40868d5f-aa22-49a2-bf4f-90e97361f327"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("a65a53b8-34b5-406b-bfec-7406e1b2432b"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("f555cb54-eb72-42ae-9e57-ef1ace4b2f8f"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("52007aed-dbf8-4fa5-b53d-d6d8e058a88b"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("d8fe7696-9fae-459a-9f72-b7b0530a93a6"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("de1cb809-c9b9-4061-accd-d4c8b938a1e4"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("4634ffd2-ffdd-4d91-8314-0ebbcfcfc4d4"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("8ae0a5bc-1477-403c-af8e-277875b8238a"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("294bb313-0f2c-4f1f-b6fc-6d2a215bbdce"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("899fa0e8-abb7-4929-b5d5-06bca3c726c8"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("b88e4120-c887-445e-89e3-ed9666eff0a4"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("a93928c3-8068-485b-9636-912e9c67d03b"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("aee3e50c-2b10-428d-8deb-10ca923965f3"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("88a4a86c-b3dd-4393-aa64-eb8e2e86e813"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("ef571280-3d55-4f2d-9a54-f7e4d3d5b99d"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("422b288f-c44a-429c-920e-20c0b515f586"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("beb018ed-51b1-4b0e-be4f-7d4e4e3fb05a"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("92e11d97-0955-4d67-8531-728cf8f5e062"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("f25044c3-ca21-4891-9cfb-8728ce5c182f"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("7fd37aa4-69a9-42de-837e-43613ed53f68"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("3f4d8628-f904-4d50-a547-804779833491"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("2829513a-ed83-4c4b-990e-2e6bdaf92e70"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("92cd9710-9a02-4913-9c10-18e8e0d2bc10"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("1d1d85de-f120-49e7-b706-31dda8cccadb"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("ff1acae3-6bef-499b-87ab-e4a2939d7173"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("354bf629-6e9c-4a2b-a5c4-cda2b215e240"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Vehicles.View",
                        ...
                        new
                        {
                            Id = new Guid("b58fcb23-7f95-444e-8e8a-3087b2e12df3"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Vehicles.Create",
                            RoleId = new Guid("1e46a445-4351-4d0a-86a4-454351dd0aa6")
                        },
                        new
                        {
                            Id = new Guid("366a083a-d158-4c75-9f5d-ee6c787516ed"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Vehicles.Edit",
                            RoleId = new Guid("1e46a445-4351-4d0a-86a4-454351dd0aa6")
                        },
                        new
                        {
                            Id = new Guid("ae7b5f52-44c9-4006-b980-97e24cba07ce"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Bookings.View",
                            RoleId = new Guid("1e46a445-4351-4d0a-86a4-454351dd0aa6")
                        },
                        new
                        {
                            Id = new Guid("53d82803-75cc-41b0-99fb-5f39677a9cc0"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Bookings.ViewDetail",
                            RoleId = new Guid("1e46a445-4351-4d0a-86a4-454351dd0aa6")
                        },
                        new
                        {
                            Id = new Guid("fc06b113-2d43-47c1-9e4b-047378b3b987"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Bookings.Edit",
                            RoleId = new Guid("1e46a445-4351-4d0a-86a4-454351dd0aa6")
                        },
                        new
                        {
                            Id = new Guid("6c65bcba-d061-40f3-8093-32da3b3fb00f"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Fuels.Create",
                            RoleId = new Guid("1e46a445-4351-4d0a-86a4-454351dd0aa6")
                        },
                        new
                        {
                            Id = new Guid("58ecfea4-3f20-43ce-afe9-4923d06d2ddf"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Fuels.Edit",
                            RoleId = new Guid("1e46a445-4351-4d0a-86a4-454351dd0aa6")
                        },
                        new
                        {
                            Id = new Guid("98294272-aa1d-4916-9b43-e44ca6506efc"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Fuels.View",
                            RoleId = new Guid("1e46a445-4351-4d0a-86a4-454351dd0aa6")
                        },
                        new
                        {
                            Id = new Guid("2b47e38d-cd80-4325-8b70-3e37885d9787"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Fuels.Delete",
                            RoleId = new Guid("1e46a445-4351-4d0a-86a4-454351dd0aa6")
                        },
                        new
                        {
                            Id = new Guid("ebf341c1-b751-4375-8da3-cdb64ce14ffc"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Vehicles.View",
                        ...
                        new
                        {
                            Id = new Guid("43bc24ea-0647-4cf8-b3ab-4ddfa093e0c2"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Bookings.View",
                            RoleId = new Guid("2fd185ee-d561-4b48-9185-eed5617b4881")
                        },
                        new
                        {
                            Id = new Guid("3ba4ae0a-0720-4061-a727-c937bb2b2333"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Bookings.ViewDetail",
                            RoleId = new Guid("2fd185ee-d561-4b48-9185-eed5617b4881")
                        },
                        new
                        {
                            Id = new Guid("35abb12c-d336-414d-8363-0bad587d127d"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Bookings.Create",
                            RoleId = new Guid("2fd185ee-d561-4b48-9185-eed5617b4881")
                        },
                        new
                        {
                            Id = new Guid("bb04342d-b0b9-4274-aeac-cac08ef1fb06"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Bookings.Create",
                        ...
                        new
                        {
                            Id = new Guid("80c2b987-6cd5-4944-8aa4-4cf1438aab06"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Bookings.View",
                            RoleId = new Guid("7a908619-1c82-4d16-9086-191c82fd1671")
                        },
                        new
                        {
                            Id = new Guid("4aaedf61-60a9-4766-bee2-9dfa5c801518"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Bookings.Cancel",
                            RoleId = new Guid("7a908619-1c82-4d16-9086-191c82fd1671")
                        });
            ...
            modelBuilder.Entity("NET_CarRentalSystem.Domain.Entities.TermsAndConditions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 25, 3, 17, 47, 405, DateTimeKind.Utc).AddTicks(9416),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 25, 3, 17, 47, 405, DateTimeKind.Utc).AddTicks(9422),
                            EffectiveDate = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            IsActive = true,
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 25, 3, 17, 47, 405, DateTimeKind.Utc).AddTicks(9426),
                            EffectiveDate = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            IsActive = true,
                            IsDeleted = false,
            ...
            modelBuilder.Entity("NET_CarRentalSystem.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 25, 3, 17, 47, 410, DateTimeKind.Utc).AddTicks(7481),
                            Email = "admin@example.com",
                            IsDeleted = false,
                            IsVerified = true,
                            Password = "$2a$11$o9W.t37Ue1sIbyIqmPRFdulDFbashcuw5IL1iZve.7GA1VVlzXlY6",
                            RowVersion = new byte[0],
                            Status = "Active",
                            UpdatedAt = new DateTime(2026, 1, 25, 3, 17, 47, 410, DateTimeKind.Utc).AddTicks(7481),
                            UserName = "admin"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            IsVerified = true,
                            Password = "$2a$11$vBAKkSfgcGy.l2SLLhpGPeSLaJz.wv8gfPhaBgFBN/ISfY3lidHYe",
                            RowVersion = new byte[0],
                            Status = "Active",
                            UpdatedAt = new DateTime(2026, 1, 25, 3, 17, 47, 410, DateTimeKind.Utc).AddTicks(7481),
                            UserName = "staff1"
                        ...
                        new
                        {
                            ...
                            IsDeleted = false,
                            IsVerified = true,
                            Password = "$2a$11$o8lJ06g087TF8M9YSq1gh.zbXSMtv7kyjHd0sqtB7inDKtGJKUpE2",
                            RowVersion = new byte[0],
                            Status = "Active",
                            UpdatedAt = new DateTime(2026, 1, 25, 3, 17, 47, 410, DateTimeKind.Utc).AddTicks(7481),
                            UserName = "customer1"
                        ...
                        new
                        {
                            ...
                            IsDeleted = false,
                            IsVerified = true,
                            Password = "$2a$11$I8BAnJSKQJ6pxqSifB1tQeqpsKr8qX3rP.GkwkGYap/2FcSarRb7.",
                            RowVersion = new byte[0],
                            Status = "Active",
                            UpdatedAt = new DateTime(2026, 1, 25, 3, 17, 47, 410, DateTimeKind.Utc).AddTicks(7481),
                            UserName = "customer2"
            ...
            modelBuilder.Entity("NET_CarRentalSystem.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserRoleId = new Guid("6822b4d9-1a2f-4e7c-b4b2-b33be43ad12f"),
                            RoleId = new Guid("71af4b53-dcd0-4498-af4b-53dcd0249826"),
                            UserId = new Guid("11111111-1111-1111-1111-111111111111")
                        },
                        new
                        {
                            UserRoleId = new Guid("64729dc7-9428-441e-9525-b78fd3180f24"),
                            RoleId = new Guid("1e46a445-4351-4d0a-86a4-454351dd0aa6"),
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        new
                        {
                            UserRoleId = new Guid("99c04ba2-41de-4d73-a7ad-81cf4eb3a002"),
                            RoleId = new Guid("2fd185ee-d561-4b48-9185-eed5617b4881"),
                            UserId = new Guid("33333333-3333-3333-3333-333333333333")
                        },
                        new
                        {
                            UserRoleId = new Guid("fb0088d5-81e9-4716-a62a-8e949ec025d6"),
                            RoleId = new Guid("7a908619-1c82-4d16-9086-191c82fd1671"),
                            UserId = new Guid("44444444-4444-4444-4444-444444444444")
                        });
                });
            ...
            modelBuilder.Entity("NET_CarRentalSystem.Domain.Entities.VehicleCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryCode = "SEDAN",
                            CreatedAt = new DateTime(2026, 1, 25, 3, 17, 48, 0, DateTimeKind.Utc).AddTicks(2991),
                            Description = "Xe sedan 4-5 chỗ, phổ thông",
                            IsDeleted = false,
                            RowVersion = new byte[0],
                            Seat = 5,
                            UpdatedAt = new DateTime(2026, 1, 25, 3, 17, 48, 0, DateTimeKind.Utc).AddTicks(2991)
                        },
                        new
                        {
