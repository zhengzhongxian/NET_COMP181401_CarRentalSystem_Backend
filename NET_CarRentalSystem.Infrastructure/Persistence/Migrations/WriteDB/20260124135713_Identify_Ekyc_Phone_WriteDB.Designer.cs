...
namespace NET_CarRentalSystem.Infrastructure.Persistence.Migrations.WriteDB
{
    ...
    [Migration("20260124135713_Identify_Ekyc_Phone_WriteDB")]
    partial class Identify_Ekyc_Phone_WriteDB
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NET_CarRentalSystem.Domain.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 24, 13, 57, 12, 380, DateTimeKind.Utc).AddTicks(673),
                            ...
                            UpdatedAt = new DateTime(2026, 1, 24, 13, 57, 12, 380, DateTimeKind.Utc).AddTicks(673),
            ...
            modelBuilder.Entity("NET_CarRentalSystem.Domain.Entities.Fuel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 24, 13, 57, 12, 381, DateTimeKind.Utc).AddTicks(1829),
                            Description = "Sử dụng xăng",
                            IsDeleted = false,
                            Name = "Gasoline",
                            RowVersion = new byte[0],
                            UpdatedAt = new DateTime(2026, 1, 24, 13, 57, 12, 381, DateTimeKind.Utc).AddTicks(1829)
                        },
                        new
                        {
            ...
            modelBuilder.Entity("NET_CarRentalSystem.Domain.Entities.InsurancePackage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 24, 13, 57, 12, 382, DateTimeKind.Utc).AddTicks(1607),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 24, 13, 57, 12, 382, DateTimeKind.Utc).AddTicks(1614),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 24, 13, 57, 12, 382, DateTimeKind.Utc).AddTicks(1616),
            ...
            modelBuilder.Entity("NET_CarRentalSystem.Domain.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Hồ Chí Minh",
                            CreatedAt = new DateTime(2026, 1, 24, 13, 57, 12, 382, DateTimeKind.Utc).AddTicks(7720),
                            IsDeleted = false,
                            Latitude = 10.7758,
                            Longitude = 106.702,
                            ...
                            RowVersion = new byte[0],
                            UpdatedAt = new DateTime(2026, 1, 24, 13, 57, 12, 382, DateTimeKind.Utc).AddTicks(7720)
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000002"),
            ...
            modelBuilder.Entity("NET_CarRentalSystem.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "74fbffa9-bc23-44a2-882f-ba48ade4689a",
                            IsDeleted = false,
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "8a2e1dfd-6dc8-42ea-88a6-56ed5141054f",
                            IsDeleted = false,
                            Name = "Manager",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "d07147c5-7dc6-451c-b360-f424c53b7ad8",
                            IsDeleted = false,
                            Name = "Staff",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "e2ea28ff-ac7a-4b27-b4ff-6995b24563b7",
                            IsDeleted = false,
                            Name = "Customer",
            ...
            modelBuilder.Entity("NET_CarRentalSystem.Domain.Entities.RoleClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6de11b94-a524-418a-9e31-e0f535c7bd13"),
                        ...
                        new
                        {
                            Id = new Guid("41d2e47f-7147-411e-8651-7ca61b2b067b"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("9fa54497-60f6-4910-8b26-067816432b0a"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("85740ce2-a825-438f-9fff-3586539ae0dd"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("ebe1ff87-0c79-46a6-a70c-8486e62044ec"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("1a842ef8-fd59-4e17-9a0f-1bc96b4a7819"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("8f91d26b-fa2a-4e25-bd16-8c047f91499f"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("b863d2d6-b3b9-443e-b10f-4cd5009d889d"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("382dae1f-2c4a-4bb7-84ab-0d1692e4af87"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("138e152b-2390-4529-9d6a-a3e492c7f0b9"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("6467472e-134a-4bee-9636-6031f997faf6"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("5cecaa68-9fb2-4c69-b860-51839b0d4e23"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("eeaccf70-1f68-47eb-b5bf-289dc76e04d0"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("633a6dff-14cc-4b5d-83e3-2c717109f5b0"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("1d44a5a5-6c8c-443e-9755-87ea9a2d066d"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("a2351518-ad91-4187-942f-1e8b47d6f535"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("0dc2ae3e-98fb-4fc3-b64e-a4856c64dcfb"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("a64636c1-c197-4d0e-906b-51b887745e04"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("f034eb9f-f52f-4ba8-a47c-89f48da12732"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("c57de18e-bac0-49d0-af86-8053b865d09b"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("dac5bc49-0a9a-4fb8-a552-f8869a95a0cf"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("ba7e0564-ed66-4e65-b521-f154650405fa"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("b51ddded-8d09-481b-a5d1-4b763940f8e5"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("9c14dbd0-1a3e-49de-97c4-36a09a51d5f9"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("950333a4-8c58-4f34-a6e1-7f85e7add914"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("845d1605-afa7-43c4-9ec2-37c97623ea7e"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("39579272-c1a7-4d48-aac2-22c2cbba947f"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("8810c42f-fcc7-444e-b1f3-e717810a33ae"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("a6a34ffe-0e1a-4eac-9ab0-16c89ac6065e"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("2c7b7762-c2cb-4016-8344-fc23f5bbfddf"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("111c2e2f-a189-4c90-8230-4238577464ac"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("8fa3a2f0-5f40-4247-a1b6-b49620c3f682"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("8d372170-c514-4af9-abf9-a1f89fe6597a"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("3116c41f-e00c-42dd-9259-c3b1420cf371"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("84f85107-01b7-4720-a5fb-ea11ca3ec53a"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("08e15697-1ba7-4b6f-a711-781f23dcdbf1"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("61e4d49f-f7a6-4327-aff8-349cdbfa3b52"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("415d10af-9301-41a6-b5fd-bdfe26c0b756"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("e9de1170-7e02-4113-a089-4a3e68e06b0b"),
                            ClaimType = "Permission",
                        ...
                        new
                        {
                            Id = new Guid("2be4799b-c188-4740-9ce8-78bc620adbc2"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Vehicles.View",
                        ...
                        new
                        {
                            Id = new Guid("d6ec73c7-48a6-4169-aa09-66c8a2ca4fea"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Vehicles.Create",
                            RoleId = new Guid("1e46a445-4351-4d0a-86a4-454351dd0aa6")
                        },
                        new
                        {
                            Id = new Guid("16dacc4d-0685-4252-93cb-93d9801165b9"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Vehicles.Edit",
                            RoleId = new Guid("1e46a445-4351-4d0a-86a4-454351dd0aa6")
                        },
                        new
                        {
                            Id = new Guid("12e7f1c6-b850-4726-8950-ace53f718a50"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Bookings.View",
                            RoleId = new Guid("1e46a445-4351-4d0a-86a4-454351dd0aa6")
                        },
                        new
                        {
                            Id = new Guid("43967c8a-7b2a-495c-af97-bcc53caea96b"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Bookings.ViewDetail",
                            RoleId = new Guid("1e46a445-4351-4d0a-86a4-454351dd0aa6")
                        },
                        new
                        {
                            Id = new Guid("10a8cc75-bdc5-45e8-883d-d73853e3d4a3"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Bookings.Edit",
                            RoleId = new Guid("1e46a445-4351-4d0a-86a4-454351dd0aa6")
                        },
                        new
                        {
                            Id = new Guid("ae0592dc-a070-47b0-9ba9-00762fbcc960"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Fuels.Create",
                            RoleId = new Guid("1e46a445-4351-4d0a-86a4-454351dd0aa6")
                        },
                        new
                        {
                            Id = new Guid("ab44c290-b18b-4159-9a3f-eaa56383a9c1"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Fuels.Edit",
                            RoleId = new Guid("1e46a445-4351-4d0a-86a4-454351dd0aa6")
                        },
                        new
                        {
                            Id = new Guid("a3dbe4fd-d316-4a0e-be80-430ca2ab49e1"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Fuels.View",
                            RoleId = new Guid("1e46a445-4351-4d0a-86a4-454351dd0aa6")
                        },
                        new
                        {
                            Id = new Guid("dd148ab5-c625-45d7-a59c-9c782e0ad6fc"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Fuels.Delete",
                            RoleId = new Guid("1e46a445-4351-4d0a-86a4-454351dd0aa6")
                        },
                        new
                        {
                            Id = new Guid("568c3a6c-01d5-4497-a741-9b89cbfd40cf"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Vehicles.View",
                        ...
                        new
                        {
                            Id = new Guid("92bc965d-43d0-46fe-be9e-d9d9889f3ff0"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Bookings.View",
                            RoleId = new Guid("2fd185ee-d561-4b48-9185-eed5617b4881")
                        },
                        new
                        {
                            Id = new Guid("87edbe39-e425-46b6-8537-6b91579df25e"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Bookings.ViewDetail",
                            RoleId = new Guid("2fd185ee-d561-4b48-9185-eed5617b4881")
                        },
                        new
                        {
                            Id = new Guid("e2b32267-d584-4a1a-a353-2749bcfd9f11"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Bookings.Create",
                            RoleId = new Guid("2fd185ee-d561-4b48-9185-eed5617b4881")
                        },
                        new
                        {
                            Id = new Guid("3e0757e8-a514-43e0-baa4-73c8ec55a7c7"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Bookings.Create",
                        ...
                        new
                        {
                            Id = new Guid("a3cb88a9-4bb5-40a2-b031-d6402f7fcd11"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Bookings.View",
                            RoleId = new Guid("7a908619-1c82-4d16-9086-191c82fd1671")
                        },
                        new
                        {
                            Id = new Guid("7c82250c-4ff0-4c05-92ad-07fccad25723"),
                            ClaimType = "Permission",
                            ClaimValue = "Permissions.Bookings.Cancel",
                            RoleId = new Guid("7a908619-1c82-4d16-9086-191c82fd1671")
                        });
            ...
            modelBuilder.Entity("NET_CarRentalSystem.Domain.Entities.TermsAndConditions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 24, 13, 57, 12, 391, DateTimeKind.Utc).AddTicks(4924),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 24, 13, 57, 12, 391, DateTimeKind.Utc).AddTicks(4932),
                            EffectiveDate = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            IsActive = true,
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 24, 13, 57, 12, 391, DateTimeKind.Utc).AddTicks(4934),
                            EffectiveDate = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            IsActive = true,
                            IsDeleted = false,
            ...
            modelBuilder.Entity("NET_CarRentalSystem.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 24, 13, 57, 12, 395, DateTimeKind.Utc).AddTicks(986),
                            Email = "admin@example.com",
                            IsDeleted = false,
                            IsVerified = true,
                            Password = "$2a$11$iqy79C3iHTFZQwaE0w0SGuair3ixx3SUeRGd45mj8o5HKvcZofM4O",
                            RowVersion = new byte[0],
                            Status = "Active",
                            UpdatedAt = new DateTime(2026, 1, 24, 13, 57, 12, 395, DateTimeKind.Utc).AddTicks(986),
                            UserName = "admin"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            IsVerified = true,
                            Password = "$2a$11$WcxhfshJTePeNvhpaYn1fONWAt4A5yi7NcFmq1emP3s25t6RGoEyi",
                            RowVersion = new byte[0],
                            Status = "Active",
                            UpdatedAt = new DateTime(2026, 1, 24, 13, 57, 12, 395, DateTimeKind.Utc).AddTicks(986),
                            UserName = "staff1"
                        ...
                        new
                        {
                            ...
                            IsDeleted = false,
                            IsVerified = true,
                            Password = "$2a$11$PTlevaqhuXFMAvo8E2fyzuSlqcgwh0id3FbfH6wcEoeXe/Aba2Fvi",
                            RowVersion = new byte[0],
                            Status = "Active",
                            UpdatedAt = new DateTime(2026, 1, 24, 13, 57, 12, 395, DateTimeKind.Utc).AddTicks(986),
                            UserName = "customer1"
                        ...
                        new
                        {
                            ...
                            IsDeleted = false,
                            IsVerified = true,
                            Password = "$2a$11$nbIpU0U7ZKNh.yPKx8w6FuPPRdDAo1XicaFbqn25nycFp89Q3esWy",
                            RowVersion = new byte[0],
                            Status = "Active",
                            UpdatedAt = new DateTime(2026, 1, 24, 13, 57, 12, 395, DateTimeKind.Utc).AddTicks(986),
                            UserName = "customer2"
            ...
            modelBuilder.Entity("NET_CarRentalSystem.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserRoleId = new Guid("b34485c5-13d2-4103-8e7b-4f0f5c7dc162"),
                            RoleId = new Guid("71af4b53-dcd0-4498-af4b-53dcd0249826"),
                            UserId = new Guid("11111111-1111-1111-1111-111111111111")
                        },
                        new
                        {
                            UserRoleId = new Guid("27392991-aa41-45df-a4fe-b9359f821a31"),
                            RoleId = new Guid("1e46a445-4351-4d0a-86a4-454351dd0aa6"),
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        new
                        {
                            UserRoleId = new Guid("23774934-2535-47b0-ad38-20d921a71d3f"),
                            RoleId = new Guid("2fd185ee-d561-4b48-9185-eed5617b4881"),
                            UserId = new Guid("33333333-3333-3333-3333-333333333333")
                        },
                        new
                        {
                            UserRoleId = new Guid("fb8ab743-dce6-49f1-a28d-99ee3c207747"),
                            RoleId = new Guid("7a908619-1c82-4d16-9086-191c82fd1671"),
                            UserId = new Guid("44444444-4444-4444-4444-444444444444")
                        });
                });
            ...
            modelBuilder.Entity("NET_CarRentalSystem.Domain.Entities.VehicleCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryCode = "SEDAN",
                            CreatedAt = new DateTime(2026, 1, 24, 13, 57, 12, 938, DateTimeKind.Utc).AddTicks(537),
                            Description = "Xe sedan 4-5 chỗ, phổ thông",
                            IsDeleted = false,
                            RowVersion = new byte[0],
                            Seat = 5,
                            UpdatedAt = new DateTime(2026, 1, 24, 13, 57, 12, 938, DateTimeKind.Utc).AddTicks(537)
                        },
                        new
                        {
